...
/*  $Header: /home/mwicks/Projects/Gaspra-projects/cvs2darcs/Repository-for-sourceforge/dvipdfm/dvi.c,v 1.46 1999/02/21 01:49:06 mwicks Exp $
...
static debug = 0;
static unsigned num_fonts = 0, stackdepth;
...
static void get_dvi_fonts (void)
{
  ...
  while (num_fonts < MAX_FONTS && (code = get_unsigned_byte(dvi_file)) != POST_POST) {
    switch (code)
      {
      case FNT_DEF1:
