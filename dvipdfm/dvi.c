/*  $Header: /home/mwicks/Projects/Gaspra-projects/cvs2darcs/Repository-for-sourceforge/dvipdfm/dvi.c,v 1.55.2.2 1999/08/25 10:53:16 mwicks Exp $
...
int dvi_locate_font (char *tex_name, mpt_t ptsize)
{
  ...
  loaded_fonts[thisfont].source = VF; /* This will be reset later if 
				     ...
				     dvi file */
  loaded_fonts[thisfont].font_id = vf_locate_font (tex_name, ptsize);
