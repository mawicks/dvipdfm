% $Header: /home/mwicks/Projects/Gaspra-projects/cvs2darcs/Repository-for-sourceforge/dvipdfm-initial/doc/dvipdfm.tex,v 1.10 1998/11/20 20:15:12 mwicks Exp $
...
but is loaded at a 50\% scale.

\topinsert
\centerline{\reserve{1.50in}{2.05in}{pdf: image rotate 30 (mwicks.jpeg)}}
\medskip
...
\medskip
\centerline{\subheadingfont
\begincolor{\blue}Figure~2---The same JPEG image of the author scaled to 50.\%
\endcolor}
\endinsert
