% $Header: /home/mwicks/Projects/Gaspra-projects/cvs2darcs/Repository-for-sourceforge/dvipdfm-initial/doc/dvipdfm.tex,v 1.11 1998/11/20 23:44:15 mwicks Exp $
...
and annotations (including hyperlinks, forms and widgets).  Nearly
...
The commands in this section deal with arbitrary transformation
of the text (and rules) typeset by \TeX.  
...
Tables with slanted entries are also possible as shown
in Table~2.  This table was achieved using
...
You \up{can} \up{nest} \down{the} \down{text} {transformation}
\down{capabilities} \down{to} \up{achieve} \up{effects} {like}
{this}.
...
Figure~1 is a photograph of the author that was included from a JPEG file:
The image shown in Figure~2 image comes from the same file,
...
Figure~3 was produced by embedding a PDF file
using |epdf|.
